...
#define EINFO_EINVAL_BLKSIZE __einfo_uniqify(EINFO_EINVAL, 0x01, "Invalid blksize")
#define EINVAL_TSIZE __einfo_error(EINFO_EINVAL_TSIZE)
#define EINFO_EINVAL_TSIZE __einfo_uniqify(EINFO_EINVAL, 0x02, "Invalid tsize")
#define EINVAL_MC_NO_PORT __einfo_error(EINFO_EINVAL_MC_NO_PORT)
#define EINFO_EINVAL_MC_NO_PORT __einfo_uniqify(EINFO_EINVAL, 0x03, "Missing multicast port")
#define EINVAL_MC_NO_MC __einfo_error(EINFO_EINVAL_MC_NO_MC)
#define EINFO_EINVAL_MC_NO_MC __einfo_uniqify(EINFO_EINVAL, 0x04, "Missing multicast mc")
#define EINVAL_MC_INVALID_MC __einfo_error(EINFO_EINVAL_MC_INVALID_MC)
#define EINFO_EINVAL_MC_INVALID_MC __einfo_uniqify(EINFO_EINVAL, 0x05, "Missing multicast IP")
#define EINVAL_MC_INVALID_IP __einfo_error(EINFO_EINVAL_MC_INVALID_IP)
#define EINFO_EINVAL_MC_INVALID_IP __einfo_uniqify(EINFO_EINVAL, 0x06, "Invalid multicast IP")
#define EINVAL_MC_INVALID_PORT __einfo_error(EINFO_EINVAL_MC_INVALID_PORT)
#define EINFO_EINVAL_MC_INVALID_PORT __einfo_uniqify(EINFO_EINVAL, 0x07, "Invalid multicast port")
