...
static const char* xsmp_session_type(unsigned int type) {
    ...
    switch (type) {
        case XSMP_SESSION_TYPE_HELLO:
            return "HELLO";
        case XSMP_SESSION_TYPE_REGISTER:
            return "REGISTER";
...
static const char* xsmp_xve_type(unsigned int type) {
    ...
    switch (type) {
        ...
        case XSMP_XVE_TYPE_UPDATE:
            return "UPDATE";
        case XSMP_XVE_TYPE_OPER_UP:
            return "OPER_UP";
        case XSMP_XVE_TYPE_OPER_DOWN:
            return "OPER_DOWN";
...
static int xsmp_tx_xve_params(struct xsigo_manager* xcm,
    ...
    if (msg->type == XSMP_XVE_TYPE_OPER_REQ) {
        msg->type = (netdev_is_open(netdev) ? XSMP_XVE_TYPE_OPER_UP : XSMP_XVE_TYPE_OPER_DOWN);
    }
