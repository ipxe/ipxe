...
extern char* const text16;
        ...
        #define __use_data16(variable) \
            (*((typeof(_data16_##variable)*)&(data16[(size_t) & (_data16_##variable)])))

        #define __use_text16(variable) \
            (*((typeof(_text16_##variable)*)&(text16[(size_t) & (_text16_##variable)])))

        #define __from_data16(pointer) \
            ((unsigned int)(((void*)(pointer)) - ((void*)data16)))

        #define __from_text16(pointer) \
            ((unsigned int)(((void*)(pointer)) - ((void*)text16)))
