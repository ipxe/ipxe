...
FILE_LICENCE(GPL2_OR_LATER_OR_UBDL);
    ...
    #define __bswap_16(value)                                                             \
        (__builtin_constant_p(value) ? ((uint16_t)__bswap_constant_16((uint16_t)(value))) \
    ...
    #define __bswap_32(value)                                                             \
        (__builtin_constant_p(value) ? ((uint32_t)__bswap_constant_32((uint32_t)(value))) \
    ...
    #define __bswap_64(value)                                                             \
        (__builtin_constant_p(value) ? ((uint64_t)__bswap_constant_64((uint64_t)(value))) \
