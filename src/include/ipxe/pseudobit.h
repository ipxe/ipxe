 ...
 */
    ...
    #define BIT_ASSEMBLE_1(_ptr, _index, _field, _value) \
        (((uint64_t)(_value)) << QWORD_BIT_SHIFT(_ptr, _index, _field))
 ...
 */
    ...
    #define BIT_MASK_1(_ptr, _index, _field) \
        (BIT_MASK(_ptr, _field) << QWORD_BIT_SHIFT(_ptr, _index, _field))
 ...
 */
    ...
    #define BIT_SET(_ptr, _field, _value)                                 \
        do {                                                              \
            ...
            *__ptr &= cpu_to_BIT64(~(BIT_MASK(_ptr, _field) << __shift)); \
