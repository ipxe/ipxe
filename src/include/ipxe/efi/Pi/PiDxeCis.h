...
**/
typedef EFI_STATUS(EFIAPI* EFI_ADD_MEMORY_SPACE)(
...
**/
typedef EFI_STATUS(EFIAPI* EFI_ALLOCATE_MEMORY_SPACE)(
...
**/
typedef EFI_STATUS(EFIAPI* EFI_FREE_MEMORY_SPACE)(
    IN EFI_PHYSICAL_ADDRESS BaseAddress,
    IN UINT64 Length);
...
**/
typedef EFI_STATUS(EFIAPI* EFI_REMOVE_MEMORY_SPACE)(
    IN EFI_PHYSICAL_ADDRESS BaseAddress,
    IN UINT64 Length);
...
**/
typedef EFI_STATUS(EFIAPI* EFI_GET_MEMORY_SPACE_DESCRIPTOR)(
    IN EFI_PHYSICAL_ADDRESS BaseAddress,
...
/**
  ...
  @retval EFI_NOT_AVAILABLE_YET The attributes cannot be set because CPU architectural protocol is
                                not available yet.
**/
typedef EFI_STATUS(EFIAPI* EFI_SET_MEMORY_SPACE_ATTRIBUTES)(
    IN EFI_PHYSICAL_ADDRESS BaseAddress,
    IN UINT64 Length,
...
**/
typedef EFI_STATUS(EFIAPI* EFI_GET_MEMORY_SPACE_MAP)(
...
**/
typedef EFI_STATUS(EFIAPI* EFI_ALLOCATE_IO_SPACE)(
    IN EFI_GCD_ALLOCATE_TYPE GcdAllocateType,
    IN EFI_GCD_IO_TYPE GcdIoType,
    IN UINTN Alignment,
    IN UINT64 Length,
...
**/
typedef EFI_STATUS(EFIAPI* EFI_GET_IO_SPACE_DESCRIPTOR)(
    IN EFI_PHYSICAL_ADDRESS BaseAddress,
...
**/
typedef EFI_STATUS(EFIAPI* EFI_PROCESS_FIRMWARE_VOLUME)(
