...
typedef struct {
    ...
    ///
    #define FFS_FILE_SIZE(FfsFileHeaderPtr) ((UINT32)((((EFI_FFS_FILE_HEADER*)(UINTN)(FfsFileHeaderPtr))->Size[0]) |      \
...
typedef struct {
    ...
    ///
    #define SECTION_SIZE(SectionHeaderPtr) ((UINT32)((((EFI_COMMON_SECTION_HEADER*)(UINTN)(SectionHeaderPtr))->Size[0]) |      \
