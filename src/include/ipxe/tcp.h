...
struct tcp_options {
    ...
    #define TCP_CAN_SEND_DATA(state)            \
        (((state) & (TCP_STATE_ACKED(TCP_SYN) | \
                     TCP_STATE_SENT(TCP_FIN))) == TCP_STATE_ACKED(TCP_SYN))
    ...
    #define TCP_HAS_BEEN_ESTABLISHED(state)     \
        (((state) & (TCP_STATE_ACKED(TCP_SYN) | \
                     TCP_STATE_RCVD(TCP_SYN))) == (TCP_STATE_ACKED(TCP_SYN) | TCP_STATE_RCVD(TCP_SYN)))
    ...
    #define TCP_CLOSED_GRACEFULLY(state)        \
        (((state) & (TCP_STATE_ACKED(TCP_FIN) | \
                     TCP_STATE_RCVD(TCP_FIN))) == (TCP_STATE_ACKED(TCP_FIN) | TCP_STATE_RCVD(TCP_FIN)))
