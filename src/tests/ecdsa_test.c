...
/** P-256 traditional private key */
PUBKEY_TEST ( p256_traditional_test, &ecdsa_algorithm,
...
PUBKEY_TEST ( p256_pkcs8_test, &ecdsa_algorithm,
...
/** P-384 PKCS#8 private key */
PUBKEY_TEST ( p384_pkcs8_test, &ecdsa_algorithm,
...
PUBKEY_SIGNATURE_TEST ( p256_hw_test, &p256_traditional_test, RANDOM(),
...
PUBKEY_SIGNATURE_TEST ( p256_hw_sha512_test, &p256_traditional_test, RANDOM(),
	PLAINTEXT ( 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x20, 0x77, 0x6f, 0x72, 0x6c,
		    0x64, 0x0a ),
	&sha512_algorithm,
...
PUBKEY_SIGNATURE_TEST ( p256_random_test, &p256_pkcs8_test, RANDOM(),
...
PUBKEY_SIGNATURE_TEST ( p384_random_test, &p384_pkcs8_test, RANDOM(),
	PLAINTEXT ( 0xe0, 0xf0, 0x1b, 0xd1, 0x95, 0xe0, 0x4b, 0xd1, 0xf7, 0x4a,
		    0x18, 0xca, 0x60, 0x02, 0x29, 0xc1, 0x58, 0x03, 0xf8, 0xc2,
		    0x3c, 0x0f, 0x86, 0x55, 0xc5, 0x22, 0x88, 0x7e, 0x1f, 0x6c,
		    0x4e, 0x14, 0xb5, 0x7e, 0x52, 0x02, 0x40, 0xb2, 0x70, 0xa6,
...
static void ecdsa_test_exec ( void ) {
	...
	pubkey_sign_verify_ok ( &p256_hw_test );
	pubkey_sign_verify_ok ( &p256_hw_sha512_test );
	pubkey_sign_verify_ok ( &p256_random_test );
	pubkey_sign_verify_ok ( &p384_random_test );
}
