...
void bigint_init_sample(bigint_element_t* value0, unsigned int size,
    ...
    bigint_t(size) * value __attribute__((may_alias)) = ((void*)value0);
...
void bigint_done_sample(const bigint_element_t* value0, unsigned int size,
                        void* out, size_t len) {
    const bigint_t(size) * value __attribute__((may_alias)) = ((const void*)value0);
...
void bigint_add_sample(const bigint_element_t* addend0,
    ...
    const bigint_t(size) * addend __attribute__((may_alias)) = ((const void*)addend0);
    bigint_t(size) * value __attribute__((may_alias)) = ((void*)value0);
...
void bigint_subtract_sample(const bigint_element_t* subtrahend0,
                            bigint_element_t* value0, unsigned int size) {
    const bigint_t(size) * subtrahend __attribute__((may_alias)) = ((const void*)subtrahend0);
    bigint_t(size) * value __attribute__((may_alias)) = ((void*)value0);
...
int bigint_is_geq_sample(const bigint_element_t* value0,
                         ...
                         unsigned int size) {
    const bigint_t(size) * value __attribute__((may_alias)) = ((const void*)value0);
    const bigint_t(size) * reference __attribute__((may_alias)) = ((const void*)reference0);
...
void bigint_grow_sample(const bigint_element_t* source0,
    ...
    const bigint_t(source_size) * source __attribute__((may_alias)) = ((const void*)source0);
    bigint_t(dest_size) * dest __attribute__((may_alias)) = ((void*)dest0);
...
void bigint_multiply_sample(const bigint_element_t* multiplicand0,
                            ...
                            unsigned int size) {
    const bigint_t(size) * multiplicand __attribute__((may_alias)) = ((const void*)multiplicand0);
    const bigint_t(size) * multiplier __attribute__((may_alias)) = ((const void*)multiplier0);
    bigint_t(size * 2) * result __attribute__((may_alias)) = ((void*)result0);
...
void bigint_mod_multiply_sample(const bigint_element_t* multiplicand0,
    ...
    const bigint_t(size) * multiplicand __attribute__((may_alias)) = ((const void*)multiplicand0);
    const bigint_t(size) * multiplier __attribute__((may_alias)) = ((const void*)multiplier0);
    const bigint_t(size) * modulus __attribute__((may_alias)) = ((const void*)modulus0);
    bigint_t(size) * result __attribute__((may_alias)) = ((void*)result0);
...
void bigint_mod_exp_sample(const bigint_element_t* base0,
                           ...
                           void* tmp) {
    const bigint_t(size) * base __attribute__((may_alias)) = ((const void*)base0);
    const bigint_t(size) * modulus __attribute__((may_alias)) = ((const void*)modulus0);
    const bigint_t(exponent_size) * exponent __attribute__((may_alias)) = ((const void*)exponent0);
    bigint_t(size) * result __attribute__((may_alias)) = ((void*)result0);
