...
/** RFC 8448 HelloRetryRequest test: client random bytes */
static const struct tls_random rfc8448_hrr_client_nonce = {
	.bytes = {
		0xb0, 0xb1, 0xc5, 0xa5, 0xaa, 0x37, 0xc5, 0x91, 0x9f, 0x2e,
		0xd1, 0xd5, 0xc6, 0xff, 0xf7, 0xfc, 0xb7, 0x84, 0x97, 0x16,
		0x94, 0x5a, 0x2b, 0x8c, 0xee, 0x92, 0x58, 0xa3, 0x46, 0x67,
		0x7b, 0x6f
	},
};

/** RFC 8448 HelloRetryRequest test: client P-256 private key */
static const uint8_t rfc8448_hrr_p256_private[] = {
	0xab, 0x54, 0x73, 0x46, 0x7e, 0x19, 0x34, 0x6c, 0xeb, 0x0a, 0x04,
	0x14, 0xe4, 0x1d, 0xa2, 0x1d, 0x4d, 0x24, 0x45, 0xbc, 0x30, 0x25,
	0xaf, 0xe9, 0x7c, 0x4e, 0x8d, 0xc8, 0xd5, 0x13, 0xda, 0x39
};

/** RFC 8448 HelloRetryRequest test: server P-256 public key */
static const uint8_t rfc8448_hrr_p256_partner[] = {
	0x04, 0x58, 0x3e, 0x05, 0x4b, 0x7a, 0x66, 0x67, 0x2a, 0xe0, 0x20,
	0xad, 0x9d, 0x26, 0x86, 0xfc, 0xc8, 0x5b, 0x5a, 0xd4, 0x1a, 0x13,
	0x4a, 0x0f, 0x03, 0xee, 0x72, 0xb8, 0x93, 0x05, 0x2b, 0xd8, 0x5b,
	0x4c, 0x8d, 0xe6, 0x77, 0x6f, 0x5b, 0x04, 0xac, 0x07, 0xd8, 0x35,
	0x40, 0xea, 0xb3, 0xe3, 0xd9, 0xc5, 0x47, 0xbc, 0x65, 0x28, 0xc4,
	0x31, 0x7d, 0x29, 0x46, 0x86, 0x09, 0x3a, 0x6c, 0xad, 0x7d
};

/** RFC 8448 HelloRetryRequest test: client hello (first) */
static const uint8_t rfc8448_hrr_clienthello1[] = {
	
};

/** RFC 8448 HelloRetryRequest test: server hello (first) */
static const uint8_t rfc8448_hrr_serverhello1[] = {
	
};

/** RFC 8448 HelloRetryRequest test: client hello (second) */
static const uint8_t rfc8448_hrr_clienthello2[] = {
	,
...
/** RFC 8448 HelloRetryRequest test: server hello (second) */
static const uint8_t rfc8448_hrr_serverhello2[] = {
	0x02, 0x00, 0x00, 0x77, 0x03, 0x03, 0xbb, 0x34, 0x1d, 0x84, 0x7f,
	0xd7, 0x89, 0xc4, 0x7c, 0x38, 0x71, 0x72, 0xdc, 0x0c, 0x9b, 0xf1,
	0x47, 0xfc, 0xca, 0xcb, 0x50, 0x43, 0xd8, 0x6c, 0xa4, 0xc5, 0x98,
	0xd3, 0xff, 0x57, 0x1b, 0x98, 0x00, 0x13, 0x01, 0x00, 0x00, 0x4f,
	0x00, 0x33, 0x00, 0x45, 0x00, 0x17, 0x00, 0x41, 0x04, 0x58, 0x3e,
	0x05, 0x4b, 0x7a, 0x66, 0x67, 0x2a, 0xe0, 0x20, 0xad, 0x9d, 0x26,
	0x86, 0xfc, 0xc8, 0x5b, 0x5a, 0xd4, 0x1a, 0x13, 0x4a, 0x0f, 0x03,
	0xee, 0x72, 0xb8, 0x93, 0x05, 0x2b, 0xd8, 0x5b, 0x4c, 0x8d, 0xe6,
	0x77, 0x6f, 0x5b, 0x04, 0xac, 0x07, 0xd8, 0x35, 0x40, 0xea, 0xb3,
	0xe3, 0xd9, 0xc5, 0x47, 0xbc, 0x65, 0x28, 0xc4, 0x31, 0x7d, 0x29,
	0x46, 0x86, 0x09, 0x3a, 0x6c, 0xad, 0x7d, 0x00, 0x2b, 0x00, 0x02,
	0x03, 0x04
};

/** RFC 8448 HelloRetryRequest test: handshake secret */
static const uint8_t rfc8448_hrr_handshake_secret[] = {
	0xce, 0x02, 0x2e, 0x5e, 0x6e, 0x81, 0xe5, 0x07, 0x36, 0xd7, 0x73,
	0xf2, 0xd3, 0xad, 0xfc, 0xe8, 0x22, 0x0d, 0x04, 0x9b, 0xf5, 0x10,
	0xf0, 0xdb, 0xfa, 0xc9, 0x27, 0xef, 0x42, 0x43, 0xb1, 0x48
};

/** RFC 8448 HelloRetryRequest test: client handshake traffic secret */
static const uint8_t rfc8448_hrr_client_handshake_traffic_secret[] = {
	0x15, 0x8a, 0xa7, 0xab, 0x88, 0x55, 0x07, 0x35, 0x82, 0xb4, 0x1d,
	0x67, 0x4b, 0x40, 0x55, 0xca, 0xbc, 0xc5, 0x34, 0x72, 0x8f, 0x65,
	0x93, 0x14, 0x86, 0x1b, 0x4e, 0x08, 0xe2, 0x01, 0x15, 0x66
};

/** RFC 8448 HelloRetryRequest test: server handshake traffic secret */
static const uint8_t rfc8448_hrr_server_handshake_traffic_secret[] = {
	0x34, 0x03, 0xe7, 0x81, 0xe2, 0xaf, 0x7b, 0x65, 0x08, 0xda, 0x28,
	0x57, 0x4f, 0x6e, 0x95, 0xa1, 0xab, 0xf1, 0x62, 0xde, 0x83, 0xa9,
	0x79, 0x27, 0xc3, 0x76, 0x72, 0xa4, 0xa0, 0xce, 0xf8, 0xa1
};
...
/**
 * Perform RFC 8448 HelloRetryRequest test
 *
 * @v tlskey		Key schedule
 */
static void rfc8448_hrr_test ( struct tls_key_schedule *tlskey ) {
	struct exchange_algorithm *exchange = &p256_algorithm;
	struct digest_algorithm *digest = &sha256_algorithm;
	size_t sharedsize = exchange->sharedsize;
	size_t digestsize = digest->digestsize;
	uint8_t shared[sharedsize];
	...
	/* Start key schedule */
	ok ( tlskey_start ( tlskey, &tlskey_hkdf, digest,
			    &rfc8448_hrr_client_nonce ) == 0 );

	/* ClientHello1 */
	tlskey_digest ( tlskey, rfc8448_hrr_clienthello1,
			sizeof ( rfc8448_hrr_clienthello1 ) );

	/* Synthesize message hash */
	tlskey_message ( tlskey );

	/* ServerHello1 */
	tlskey_digest ( tlskey, rfc8448_hrr_serverhello1,
			sizeof ( rfc8448_hrr_serverhello1 ) );

	/* ClientHello2 */
	tlskey_digest ( tlskey, rfc8448_hrr_clienthello2,
			sizeof ( rfc8448_hrr_clienthello2 ) );

	/* ServerHello2 */
	tlskey_digest ( tlskey, rfc8448_hrr_serverhello2,
			sizeof ( rfc8448_hrr_serverhello2 ) );
	ok ( exchange_agree ( exchange, rfc8448_hrr_p256_private,
			      rfc8448_hrr_p256_partner, shared ) == 0 );
	ok ( tlskey_apply ( tlskey, shared, sizeof ( shared ) ) == 0 );

	/* Handshake secret */
	ok ( memcmp ( rfc8448_hrr_handshake_secret,
		      tlskey->kdf.secret, digestsize ) == 0 );

	/* Client handshake traffic secret */
	ok ( tlskey_traffic ( tlskey, &tls_client, &tls_handshake ) == 0 );
	ok ( memcmp ( rfc8448_hrr_client_handshake_traffic_secret,
		      tlskey->traffic[TLS_CLIENT].secret, digestsize ) == 0 );

	/* Server handshake traffic secret */
	ok ( tlskey_traffic ( tlskey, &tls_server, &tls_handshake ) == 0 );
	ok ( memcmp ( rfc8448_hrr_server_handshake_traffic_secret,
		      tlskey->traffic[TLS_SERVER].secret, digestsize ) == 0 );
}
...
static void tlskey_test_exec ( void ) {
	...
	/* RFC 8448 HelloRetryRequest test */
	rfc8448_hrr_test ( &tlskey );
