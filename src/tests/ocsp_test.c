 ...
 */
#define ocsp_certificate_ok(crt)                     \
    do {                                             \
 ...
 * @v test		OCSP test
 */
#define ocsp_response_fail_ok(test)                      \
    do {                                                 \
        ok(ocsp_response((test)->ocsp, (test)->response, \
                         (test)->response_len) != 0);    \
    } while (0)
 ...
 * @v time		Test time
 */
#define ocsp_validate_ok(test, time)                \
    do {                                            \
        ocsp_prepare_test((test));                  \
 ...
 * @v time		Test time
 */
#define ocsp_validate_fail_ok(test, time)           \
    do {                                            \
        ocsp_prepare_test((test));                  \
        ok(ocsp_validate((test)->ocsp, time) != 0); \
    } while (0)
