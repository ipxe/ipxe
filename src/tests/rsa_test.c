...
/** Invalid PKCS#1 padding key (from Project Wycheproof) */
PUBKEY_TEST ( wycheproof_key, &rsa_algorithm,
...
/** Invalid PKCS#1 padding test (from Project Wycheproof) */
PUBKEY_ENCRYPTION_TEST ( wycheproof_padding_test, &wycheproof_key, RANDOM(),
...
static void rsa_test_exec ( void ) {
	...
	pubkey_decrypt_fail_ok ( &wycheproof_padding_test );
