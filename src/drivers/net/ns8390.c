...
Error you must only define one of INCLUDE_WD, INCLUDE_3C503, INCLUDE_NE, INCLUDE_NS8390
        ...
        #define eth_probe t503_probe
                                                                             ...
                                                                             Error you must only define one of INCLUDE_WD,
    INCLUDE_3C503, INCLUDE_NE, INCLUDE_NS8390
        #endif
    #endif
    ...
    **************************************************************************/
    static void
    eth_pio_read(unsigned int src, unsigned char*dst, unsigned int cnt)
{
        #ifdef INCLUDE_WD
...
static void eth_pio_write(const unsigned char* src, unsigned int dst, unsigned int cnt)
{
    ...
    for (x = 0;
         ...
         (inb(eth_nic_base + D8390_P0_ISR) & D8390_ISR_RDC) != D8390_ISR_RDC;
         ++x)
        ;
