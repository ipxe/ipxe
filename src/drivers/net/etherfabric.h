...
typedef union efab_oword {
    ...
    #define EFAB_INSERT_NATIVE32(min, max, low, high, value) \
        (((low > max) || (high < min)) ? 0 : ((low > min) ? (((uint32_t)(value)) << (low - min)) : (((uint32_t)(value)) >> (min - low))))
 ...
 */
    ...
    #define EFAB_SET_OWORD_FIELD64(oword, field, value)                                                                              \
        do {                                                                                                                         \
            (oword).u64[0] = (((oword).u64[0] & ~EFAB_INPLACE_MASK64(0, 63, field)) | EFAB_INSERT_FIELD64(0, 63, field, value));     \
            (oword).u64[1] = (((oword).u64[1] & ~EFAB_INPLACE_MASK64(64, 127, field)) | EFAB_INSERT_FIELD64(64, 127, field, value)); \
        } while (0)

    #define EFAB_SET_QWORD_FIELD64(qword, field, value)                                                                          \
        do {                                                                                                                     \
            (qword).u64[0] = (((qword).u64[0] & ~EFAB_INPLACE_MASK64(0, 63, field)) | EFAB_INSERT_FIELD64(0, 63, field, value)); \
        } while (0)

    #define EFAB_SET_OWORD_FIELD32(oword, field, value)                                                                              \
        do {                                                                                                                         \
            (oword).u32[0] = (((oword).u32[0] & ~EFAB_INPLACE_MASK32(0, 31, field)) | EFAB_INSERT_FIELD32(0, 31, field, value));     \
            (oword).u32[1] = (((oword).u32[1] & ~EFAB_INPLACE_MASK32(32, 63, field)) | EFAB_INSERT_FIELD32(32, 63, field, value));   \
            (oword).u32[2] = (((oword).u32[2] & ~EFAB_INPLACE_MASK32(64, 95, field)) | EFAB_INSERT_FIELD32(64, 95, field, value));   \
            (oword).u32[3] = (((oword).u32[3] & ~EFAB_INPLACE_MASK32(96, 127, field)) | EFAB_INSERT_FIELD32(96, 127, field, value)); \
        } while (0)

    #define EFAB_SET_QWORD_FIELD32(qword, field, value)                                                                            \
        do {                                                                                                                       \
            (qword).u32[0] = (((qword).u32[0] & ~EFAB_INPLACE_MASK32(0, 31, field)) | EFAB_INSERT_FIELD32(0, 31, field, value));   \
            (qword).u32[1] = (((qword).u32[1] & ~EFAB_INPLACE_MASK32(32, 63, field)) | EFAB_INSERT_FIELD32(32, 63, field, value)); \
        } while (0)

    #define EFAB_SET_DWORD_FIELD(dword, field, value)                                                                            \
        do {                                                                                                                     \
            (dword).u32[0] = (((dword).u32[0] & ~EFAB_INPLACE_MASK32(0, 31, field)) | EFAB_INSERT_FIELD32(0, 31, field, value)); \
        } while (0)
    ...
    #define EFAB_DMA_MAX_MASK ((DMA_ADDR_T_WIDTH == 64) ? ~((uint64_t)0) : ~((uint32_t)0))
