...
FILE_LICENCE(GPL2_ONLY);
    ...
    #define VXGE_ALL (VXGE_INFO | VXGE_INTR | VXGE_XMIT | VXGE_POLL | VXGE_ERR | VXGE_TRACE)
 ...
 *
 */
static inline void vxge_hw_ring_rxd_1b_set(struct vxge_hw_ring_rxd_1* rxdp,
 ...
 * Returns: link state.
 */
static inline enum vxge_hw_device_link_state vxge_hw_device_link_state_get(
