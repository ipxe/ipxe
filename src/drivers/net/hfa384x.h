...
int hfa384x_drvr_chinforesults(hfa384x_t* hw);
int hfa384x_drvr_commtallies(hfa384x_t* hw);
int hfa384x_drvr_disable(hfa384x_t* hw, uint16_t macport);
int hfa384x_drvr_enable(hfa384x_t* hw, uint16_t macport);
int hfa384x_drvr_flashdl_enable(hfa384x_t* hw);
int hfa384x_drvr_flashdl_disable(hfa384x_t* hw);
int hfa384x_drvr_flashdl_write(hfa384x_t* hw, uint32_t daddr, void* buf, uint32_t len);
int hfa384x_drvr_getconfig(hfa384x_t* hw, uint16_t rid, void* buf, uint16_t len);
int hfa384x_drvr_handover(hfa384x_t* hw, uint8_t* addr);
int hfa384x_drvr_hostscanresults(hfa384x_t* hw);
int hfa384x_drvr_low_level(hfa384x_t* hw, hfa384x_metacmd_t* cmd);
int hfa384x_drvr_mmi_read(hfa384x_t* hw, uint32_t address, uint32_t* result);
int hfa384x_drvr_mmi_write(hfa384x_t* hw, uint32_t address, uint32_t data);
int hfa384x_drvr_ramdl_enable(hfa384x_t* hw, uint32_t exeaddr);
int hfa384x_drvr_ramdl_disable(hfa384x_t* hw);
int hfa384x_drvr_ramdl_write(hfa384x_t* hw, uint32_t daddr, void* buf, uint32_t len);
int hfa384x_drvr_readpda(hfa384x_t* hw, void* buf, unsigned int len);
int hfa384x_drvr_scanresults(hfa384x_t* hw);

int hfa384x_drvr_setconfig(hfa384x_t* hw, uint16_t rid, void* buf, uint16_t len);
...
int hfa384x_cmd_enable(hfa384x_t* hw, uint16_t macport);
int hfa384x_cmd_disable(hfa384x_t* hw, uint16_t macport);
int hfa384x_cmd_diagnose(hfa384x_t* hw);
int hfa384x_cmd_allocate(hfa384x_t* hw, uint16_t len);
int hfa384x_cmd_transmit(hfa384x_t* hw, uint16_t reclaim, uint16_t qos, uint16_t fid);
int hfa384x_cmd_clearpersist(hfa384x_t* hw, uint16_t fid);
int hfa384x_cmd_notify(hfa384x_t* hw, uint16_t reclaim, uint16_t fid, void* buf, uint16_t len);
int hfa384x_cmd_inquire(hfa384x_t* hw, uint16_t fid);
int hfa384x_cmd_access(hfa384x_t* hw, uint16_t write, uint16_t rid, void* buf, uint16_t len);
int hfa384x_cmd_monitor(hfa384x_t* hw, uint16_t enable);
int hfa384x_cmd_download(
    hfa384x_t* hw,
    uint16_t mode,
    uint16_t lowaddr,
    uint16_t highaddr,
...
int hfa384x_copy_to_bap(
    ...
    void* buf,
    unsigned int len);
void hfa384x_copy_from_aux(
    hfa384x_t* hw,
    uint32_t cardaddr,
    uint32_t auxctl,
    void* buf,
    unsigned int len);
void hfa384x_copy_to_aux(
    hfa384x_t* hw,
    uint32_t cardaddr,
    uint32_t auxctl,
    void* buf,
