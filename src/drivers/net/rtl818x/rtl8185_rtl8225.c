...
static void rtl8225_rf_init(struct net80211_device* dev)
{
    ...
    mdelay(1);
    rtl8225_write_phy_ofdm(dev, 0x02, 0x62);
    mdelay(1);
    ...
    mdelay(1);
    rtl8225_write_phy_ofdm(dev, 0x06, 0x00);
    mdelay(1);
    rtl8225_write_phy_ofdm(dev, 0x07, 0x00);
    mdelay(1);
    rtl8225_write_phy_ofdm(dev, 0x08, 0x00);
    mdelay(1);
    ...
    mdelay(1);
    rtl8225_write_phy_ofdm(dev, 0x11, 0x03);
    mdelay(1);
    ...
    mdelay(1);
    rtl8225_write_phy_cck(dev, 0x10, 0x93);
    mdelay(1);
...
static void rtl8225z2_rf_init(struct net80211_device* dev)
{
    ...
    rtl8225_write_phy_ofdm(dev, 0x1a, 0x20);
    mdelay(1);
    rtl8225_write_phy_ofdm(dev, 0x1b, 0x11);
    mdelay(1);
    rtl8225_write_phy_ofdm(dev, 0x1c, 0x04);
    mdelay(1);
    rtl8225_write_phy_ofdm(dev, 0x1d, 0xc5);
    mdelay(1);
    rtl8225_write_phy_ofdm(dev, 0x1e, 0xb3);
    mdelay(1);
    rtl8225_write_phy_ofdm(dev, 0x1f, 0x75);
    mdelay(1);
    rtl8225_write_phy_ofdm(dev, 0x20, 0x1f);
    ...
    rtl8225_write_phy_cck(dev, 0x1b, 0x08);
    rtl8225_write_phy_cck(dev, 0x40, 0x86);
    rtl8225_write_phy_cck(dev, 0x41, 0x8a);
    mdelay(1);
    rtl8225_write_phy_cck(dev, 0x42, 0x15);
    mdelay(1);
    rtl8225_write_phy_cck(dev, 0x43, 0x18);
    ...
    rtl818x_iowrite8(priv, (u8*)priv->map + 0x5B, 0x0D);
    mdelay(1);
