...
/*=============================================================*/
        ...
        #define WLAN_LOG_INFO5(x, n1, n2, n3, n4, n5) printk(KERN_INFO x, (n1), (n2), (n3), (n4), (n5));
            ...
            #define DBFENTER                           \
                {                                      \
                    if (WLAN_DBVAR >= 4) {             \
                        WLAN_LOG_DEBUG0(3, "Enter\n"); \
                    }                                  \
                }
            #define DBFEXIT                           \
                {                                     \
                    if (WLAN_DBVAR >= 4) {            \
                        WLAN_LOG_DEBUG0(3, "Exit\n"); \
                    }                                 \
                }

            #define WLAN_LOG_DEBUG0(l, x) \
                if (WLAN_DBVAR >= (l))    \
                    printk(KERN_DEBUG "%s: " x, __FUNCTION__);
            #define WLAN_LOG_DEBUG1(l, x, n) \
                if (WLAN_DBVAR >= (l))       \
                    printk(KERN_DEBUG "%s: " x, __FUNCTION__, (n));
            #define WLAN_LOG_DEBUG2(l, x, n1, n2) \
                if (WLAN_DBVAR >= (l))            \
                    printk(KERN_DEBUG "%s: " x, __FUNCTION__, (n1), (n2));
            #define WLAN_LOG_DEBUG3(l, x, n1, n2, n3) \
                if (WLAN_DBVAR >= (l))                \
                    printk(KERN_DEBUG "%s: " x, __FUNCTION__, (n1), (n2), (n3));
            #define WLAN_LOG_DEBUG4(l, x, n1, n2, n3, n4) \
                if (WLAN_DBVAR >= (l))                    \
                    printk(KERN_DEBUG "%s: " x, __FUNCTION__, (n1), (n2), (n3), (n4));
            #define WLAN_LOG_DEBUG5(l, x, n1, n2, n3, n4, n5) \
                if (WLAN_DBVAR >= (l))                        \
                    printk(KERN_DEBUG "%s: " x, __FUNCTION__, (n1), (n2), (n3), (n4), (n5));
            #define WLAN_LOG_DEBUG6(l, x, n1, n2, n3, n4, n5, n6) \
                if (WLAN_DBVAR >= (l))                            \
                    printk(KERN_DEBUG "%s: " x, __FUNCTION__, (n1), (n2), (n3), (n4), (n5), (n6));
        #else
            #define WLAN_ASSERT(c)
...
typedef struct wait_queue wait_queue_t;
            #define set_current_state(b)  \
                {                         \
                    current->state = (b); \
                    mb();                 \
                }
            #define init_waitqueue_entry(a, b) \
                { (a)->task = current; }
        #endif
    #endif
