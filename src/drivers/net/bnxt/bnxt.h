...
#define DID_57454_VF_HV         0x1607
#define DID_57454_VF_HV_RDMA    0x1608
#define DID_57412_VF_HV         0x16c5
#define DID_57412_VF_HV_RDMA    0x16bd
...
#define DID_SR2_58814		0xd814
#define DID_SR2_58818		0xd818
#define DID_SR2_NVME		0x1799
#define DID_SR2_58812_VF	0xd82a
#define DID_SR2_58812_RDMA	0xd82b
#define DID_SR2_58814_VF	0xd82c
#define DID_SR2_58814_RDMA	0xd82d
#define DID_SR2_58818_VF	0xd82e
#define DID_SR2_58818_RDMA	0xd82f
#define DID_SR2_58812_HV	0x1902
#define DID_SR2_58812_HV_RDMA	0x1903
#define DID_SR2_58814_HV	0x1906
#define DID_SR2_58814_HV_RDMA	0x1907
#define DID_SR2_58818_HV	0x190a
#define DID_SR2_58818_HV_RDMA	0x190b

#define PCI_VID_SR2_VIO		0x1af4
#define DID_SR2_VIO_NET		0x1041
#define DID_SR2_VIO_BLK		0x1042
#define DID_SR2_VIO_CONSOLE	0x1043

#define CHIP_NUM(p)(((p)->chip_num) & 0xffff)

#define IS_CHIP_P5(p)	\
	((CHIP_NUM(p) == DID_57508)			|| \
	(CHIP_NUM(p) == DID_57504)			|| \
	(CHIP_NUM(p) == DID_57502)			|| \
	(CHIP_NUM(p) == DID_57502_MF)		|| \
	(CHIP_NUM(p) == DID_57504_MF)		|| \
	(CHIP_NUM(p) == DID_57508_MF)		|| \
	(CHIP_NUM(p) == DID_57502_MF_RDMA)	|| \
	(CHIP_NUM(p) == DID_57504_MF_RDMA)	|| \
	(CHIP_NUM(p) == DID_57508_MF_RDMA)	|| \
	(CHIP_NUM(p) == DID_57508_VF)		|| \
	(CHIP_NUM(p) == DID_57508_VF_RDMA)	|| \
	(CHIP_NUM(p) == DID_57508_VF_HV)	|| \
	(CHIP_NUM(p) == DID_57508_VF_RDMA_HV))
