...
txnic_lmac_diag(struct txnic_lmac* lmac) {
    ...
    DBGC(vnic, "TXNIC %s BR %04llx:%04llx%s%s%s%s%s\n",
         ...
         ((br_status1 & BGX_SPU_BR_STATUS1_BLK_LOCK) ? " BLK_LOCK" : ""),
         ((br_status2 & BGX_SPU_BR_STATUS2_LATCHED_LOCK) ? " LATCHED_LOCK" : ""),
         ((br_status2 & BGX_SPU_BR_STATUS2_LATCHED_BER) ? " LATCHED_BER" : ""));
    ...
    DBGC(vnic, "TXNIC %s BR ALGN %016llx%s\n", vnic->name, br_algn_status,
         ((br_algn_status & BGX_SPU_BR_ALGN_STATUS_ALIGND) ? " ALIGND" : ""));
    ...
    DBGC(vnic, "TXNIC %s BR AN %04llx%s%s%s%s%s\n", vnic->name, an_status,
         ...
         ((an_status & BGX_SPU_AN_STATUS_AN_COMPLETE) ? " AN_COMPLETE" : ""),
         ((an_status & BGX_SPU_AN_STATUS_LINK_STATUS) ? " LINK_STATUS" : ""),
         ((an_status & BGX_SPU_AN_STATUS_LP_AN_ABLE) ? " LP_AN_ABLE" : ""));
