...
enum pci_dev_reg_4 {
    ...
    P_ASPM_CONTROL_MSK = P_FORCE_ASPM_REQUEST | P_ASPM_GPHY_LINK_DOWN | P_ASPM_CLKRUN_REQUEST | P_ASPM_INT_FIFO_EMPTY,
};
...
enum {
    ...
    PHY_M_DEF_MSK = PHY_M_IS_LSP_CHANGE | PHY_M_IS_LST_CHANGE | PHY_M_IS_DUP_CHANGE,
...
enum {
    ...
    /* Transmitter Disable (88E1111 only) */
};
...
static inline u32 gma_read32(struct sky2_hw* hw, unsigned port, unsigned reg)
{
    ...
    return (u32)sky2_read16(hw, base) | (u32)sky2_read16(hw, base + 4) << 16;
}
