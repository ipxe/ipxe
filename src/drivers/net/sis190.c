                            ...
                            u16 mii_status)
{
    ...
    if (p->id[1]) {
        phy->type = (p->type == MIX) ? ((mii_status & (BMSR_100FULL | BMSR_100HALF)) ? LAN : HOME) : p->type;
...
static void sis190_set_speed_auto(struct net_device* dev)
{
    ...
    // unchanged.
    mdio_write(ioaddr, phy_id, MII_ADVERTISE, (val & ADVERTISE_SLCT) | ADVERTISE_100FULL | ADVERTISE_10FULL | ADVERTISE_100HALF | ADVERTISE_10HALF);
