...
enum {
	...
	GOLAN_CMD_OP_QUERY_ISSI			= 0x10a,
	GOLAN_CMD_OP_SET_ISSI			= 0x10b,
	...
	GOLAN_CMD_OP_ALLOC_TRANSPORT_DOMAIN	= 0x816,
	GOLAN_CMD_OP_CREATE_SQ			= 0x904,
	GOLAN_CMD_OP_MODIFY_SQ			= 0x905,
	GOLAN_CMD_OP_QUERY_SQ			= 0x907,
	GOLAN_CMD_OP_CREATE_RQ			= 0x908,
	GOLAN_CMD_OP_MODIFY_RQ			= 0x909,
	GOLAN_CMD_OP_CREATE_TIR			= 0x900,
	GOLAN_CMD_OP_CREATE_TIS			= 0x912,
	GOLAN_CMD_OP_CREATE_FLOW_TABLE		= 0x930,
	GOLAN_CMD_OP_CREATE_FLOW_GROUP		= 0x933,
	GOLAN_CMD_OP_SET_FLOW_TABLE_ENTRY	= 0x936,
